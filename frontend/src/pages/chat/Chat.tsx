...
import CodeCamp from "../../assets/CodeCamp.svg";
                        ...
                        {!messages || messages.length < 1 ? (
                            <Stack className={styles.chatEmptyState}>
                                <img
                                    ...
                                    aria-hidden="true"
                                />
                                <h1 className={styles.chatEmptyStateTitle}>Stell mir eine Frage!</h1>
                                <h2 className={styles.chatEmptyStateSubtitle}>Dieser Chatbot beantwortet Deine Fragen.</h2>
                            </Stack>
                        ) : (
